...
/* harmony import */ var _modules_showMoreFiles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/showMoreFiles */ "./src/js/modules/showMoreFiles.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_showMoreFiles__WEBPACK_IMPORTED_MODULE_3__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_4__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', state);
  ...
  Object(_modules_pictures__WEBPACK_IMPORTED_MODULE_6__["default"])('.sizes-block');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _changeModalSate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./changeModalSate */ "./src/js/modules/changeModalSate.js");
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var calcFunc = function calcFunc(e) {
    ...
    Object(_changeModalSate__WEBPACK_IMPORTED_MODULE_0__["default"])(e.target, state);
...
/***/ "./src/js/modules/changeModalSate.js":
/*!*******************************************!*\
  !*** ./src/js/modules/changeModalSate.js ***!
  \*******************************************/
/*! exports provided: default */
...
var changeModalState = function changeModalState(target, state) {
...
var filter = function filter() {
  ...
  var bindElems = function bindElems(selector) {
    var available = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    var btn = menu.querySelector(selector),
        mark = wrapper.querySelectorAll(selector);
    btn.addEventListener('click', function () {
      return typeFilter(available ? mark : '');
    });
  };
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      modal = document.querySelector('.popup_calc_end'); // checkNumInputs('input[name="user_phone"]');
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_4__["postData"])('assets/server.php', formData).then(function (res) {
        console.log(res);
...
var modals = function modals() {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var validate = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  ...
  function showModalByScroll(selector) {
    document.addEventListener('scroll', function () {
      ...
      if (!btnPressed && pageYOffset >= scrollHeight - innerHeight) {
  ...
  showModalByScroll('.fixed-gift'); // showModalByTime('.popup-consultation', 5000);
};
...
/***/ "./src/js/modules/showMoreFiles.js":
/*!*****************************************!*\
  !*** ./src/js/modules/showMoreFiles.js ***!
  \*****************************************/
/*! exports provided: default */
...
var showMoreFiles = function showMoreFiles(trigger, wrapper) {
...
/* harmony default export */ __webpack_exports__["default"] = (showMoreFiles);
